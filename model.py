...
df = pd.read_csv(r'D:\Spam-Email-Detector-using-ML-main\Spam-Email-Detector-using-ML-main\spam.csv')
...
db_path = r'D:\Spam-Email-Detector-using-ML-main\Spam-Email-Detector-using-ML-main\spam_detection.db'
